...
const { bakeAndSellPies } = require("../practice");
...
describe("bakeAndSellPies(pieType, pieQuantity, profitMargin)", () => {
  ...
  context("apple pies", () => {
    it("bakeAndSellPies('applePie', 5, 2.5) should print the right ingredients, cost, and revenue", () => {
      ...
      expectedPrintOutputs.forEach((output, idx) => {
        expect(spy)
          .on.nth(idx + 1)
          .be.called.with(output);
      });
    });
  });

  context("pumpkin pies", () => {
    it("bakeAndSellPies('pumpkinPie', 2) should print the right ingredients, cost, and revenue", () => {
  ...
  context("cherry pies", () => {
    it("bakeAndSellPies('cherryPie', 7, 1.7) should print the right ingredients, cost, and revenue", () => {
